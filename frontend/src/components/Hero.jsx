...
const Hero = () => {
    return (
        <>
            <div className="relative bg-white my-5 mx-10 p-10 rounded-4xl min-h-[600px] flex flex-col items-center justify-center text-center bg-cover bg-center bg-no-repeat"
